...
import { AlertTriangle, Clock, ArrowRight, Trash2, ShieldAlert, Mail } from 'lucide-react';
      ...
      <div className="w-full max-w-xl text-center space-y-10 animate-in fade-in slide-in-from-bottom-10 duration-1000">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-xl font-bold tracking-tight">
            Votre cycle de 14 jours Qualisoft Elite est arrivé à échéance.
          </p>
          <div className="bg-red-500/5 border border-red-500/10 p-6 rounded-3xl mt-6">
            <p className="text-slate-500 text-sm leading-relaxed font-bold italic">
              Conformément à nos protocoles de sécurité §7.5, vos données ont été anonymisées. 
              <span className="text-red-500/80 block mt-2 font-black uppercase text-xs tracking-widest">⚠️ Suppression définitive prévue sous 48 heures.</span>
            </p>
          </div>
        </div>
        ...
        <div className="text-[11px] text-slate-600 font-bold max-w-sm mx-auto leading-relaxed bg-white/2 py-4 px-8 rounded-full border border-white/5">
          ...
          <a href="mailto:commercial@qualisoft.sn" className="text-blue-500 hover:text-blue-400 ml-2 font-black uppercase italic transition-colors flex items-center justify-center gap-2 mt-2">
