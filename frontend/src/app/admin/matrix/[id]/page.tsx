...
export default function TenantCockpit() {
  ...
  const fetchTenantDetails = useCallback(async () => {
    ...
    catch (err) { toast.error("SYNC MATRIX ERROR"); } finally { setLoading(false); }
  }, [tenantId]);
