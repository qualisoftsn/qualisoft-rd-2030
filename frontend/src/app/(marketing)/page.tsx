    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <nav className="flex justify-between items-center py-6 px-10 border-b">
        <div className="text-2xl font-bold text-blue-600">
          Qualisoft <span className="text-slate-400">Elite</span>
        </div>
      ...
      <section className="pt-20 pb-24 px-6 max-w-6xl mx-auto text-center">
        <h1 className="text-6xl font-extrabold leading-tight mb-6">
          notre Conformité ISO 9001 sur <br />
        ...
        <p className="text-xl text-slate-500 mb-10 max-w-3xl mx-auto">
          ...
          contraintes réglementaires en leviers de performance. Sans Excel, sans
          stress.
        </p>
        <div className="flex justify-center gap-4">
          <Link
            href="/onboarding"
            className="bg-blue-600 text-white px-10 py-5 rounded-xl text-lg font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 transition-all hover:scale-105"
          >
            Démarrer mon essai Elite gratuit
          </Link>
        </div>
        <p className="mt-4 text-sm text-slate-400">
          Essai de 14 jours — Aucune carte bancaire requise
        </p>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-12">
          <div className="bg-white p-8 rounded-2xl shadow-sm">
            ...
            <p className="text-slate-500">
              Isolation multi-tenant stricte. Vos données industrielles sont
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border-t-4 border-blue-600">
            ...
            <p className="text-slate-500">
              Visualisez notre niveau de conformité en temps réel. Soyez prêt
              pour l&apos;audit à chaque instant.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-sm">
            <div className="text-3xl mb-4">👷</div>
            ...
            <p className="text-slate-500">
              Déclarez les incidents depuis vos chantiers sur tablette.
              Réactivité maximale.
            </p>
          </div>
        </div>
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-16">
            Choisissez notre niveau d&apos;ambition
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-10 border rounded-3xl text-left hover:border-blue-200 transition">
              ...
              <Link
                href="/onboarding"
                className="block text-center py-3 rounded-lg border border-slate-200 font-semibold hover:bg-slate-50"
              >
                S&apos;inscrire
              </Link>
            </div>
            ...
            <div className="p-10 bg-slate-900 text-white rounded-3xl text-left transform md:-translate-y-4 shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-blue-600 text-xs font-bold px-4 py-1 rounded-bl-lg uppercase">
                Recommandé
              </div>
              ...
              <Link
                href="/onboarding"
                className="block text-center py-4 rounded-xl bg-blue-600 font-bold hover:bg-blue-500 transition"
              >
                Essayer ELITE gratuitement
              </Link>
            </div>
          </div>
        </div>
