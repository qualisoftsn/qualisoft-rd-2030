    ...
    <div className="fixed inset-0 bg-black/95 backdrop-blur-2xl z-500 flex items-center justify-center p-6 text-left italic">
      <div className="bg-[#0F172A] w-full max-w-2xl rounded-[4rem] shadow-4xl overflow-hidden border border-white/10 animate-in zoom-in-95 duration-500">
        ...
        <div className="p-10 border-b border-white/5 flex justify-between items-center bg-white/2 shadow-inner">
          ...
          <button
            onClick={onClose}
            className="p-4 bg-white/5 hover:bg-red-600/20 rounded-2xl transition-all border-none cursor-pointer text-slate-400 hover:text-red-500"
          >
            <X size={28} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-12 space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 ml-4 italic">
              ...
              >
                ...
                <option value="SITUATION_DANGEREUSE">
          ...
          {/* DESCRIPTION & LÉSIONS */}
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 ml-4 italic text-left">
            ...
            <textarea
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  SSE_Description: e.target.value.toUpperCase(),
                })
              }
              required
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <MapPin
                  className="absolute left-6 top-6 text-orange-500"
                  size={18}
                />
                <input
                  type="text"
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      SSE_Lieu: e.target.value.toUpperCase(),
                    })
                  }
                  required
                />
            ...
            <div
              className={`flex items-center gap-6 p-6 rounded-2xl border transition-all ${formData.SSE_AvecArret ? "bg-orange-600/10 border-orange-500/30" : "bg-white/2 border-white/5"}`}
            >
              <div className="flex items-center gap-4 flex-1">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      SSE_AvecArret: e.target.checked,
                    })
                  }
                />
                <label
                  htmlFor="avecArret"
                  className="font-black italic uppercase text-[10px] text-white tracking-widest leading-none cursor-pointer"
                >
                  Accident avec arrêt
                </label>
              </div>
