        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 font-bold text-[10px] uppercase tracking-[0.5em] mt-6 italic flex items-center gap-2">
              ...
              Focus Opérationnel • Qualisoft Elite 2026 • Système de Management
              Intégré
            </p>
          </div>
        ...
        <div className="col-span-12 lg:col-span-8 space-y-10">
          {error ? (
            <div className="bg-red-500/10 border border-red-500/20 rounded-[3.5rem] p-12 text-center">
              ...
              <p className="text-slate-500 text-xs italic uppercase">
                Aucun processus n&apos;est rattaché à notre profil
                d&apos;utilisateur.
              </p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center gap-10">
                    ...
                    <div className="text-left">
                      <h2 className="text-4xl font-black uppercase tracking-tighter mb-3 leading-none italic">
                        Accéder à mon{" "}
                        <span className="text-blue-500">Cockpit</span>
                      </h2>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-10">
          ...
          <div className="bg-white/2 border border-white/5 rounded-[3.5rem] p-10 backdrop-blur-sm shadow-2xl">
            ...
            <div className="space-y-8">
              ...
              <AlertItem
                count={1}
                label="Indicateur hors cible"
                color="text-amber-500"
              />
              <AlertItem
                count={5}
                label="Docs à réviser"
                color="text-blue-500"
              />
            </div>
    ...
    <Link href={href}>
      <div className="bg-white/2 border border-white/5 p-10 rounded-[3rem] hover:bg-white/5 hover:border-white/10 transition-all cursor-pointer group shadow-xl">
        <div className="flex items-start justify-between mb-6">
          <div
            className={`p-4 rounded-2xl bg-white/5 ${color} group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] transition-all`}
          >
            <Icon size={28} />
          </div>
          <ArrowRight
            size={18}
            className="text-slate-800 group-hover:text-white transition-all"
          />
        </div>
        <div className="text-left">
          <h4 className="text-lg font-black uppercase italic text-white group-hover:text-blue-500 transition-colors leading-none mb-2">
            {title}
          </h4>
          <p className="text-[9px] font-black uppercase italic text-slate-600 tracking-widest">
            {subtitle}
          </p>
        </div>
      </div>
...
function AlertItem({ count, label, color }: any) {
  return (
    <div className="flex items-center gap-6 group cursor-pointer text-left">
      <div
        className={`text-4xl font-black italic min-w-10 ${color} group-hover:scale-110 transition-transform leading-none`}
      >
        {count}
      </div>
