...
import { 
  FileDown, ShieldCheck, Mail, Building2, 
  User, ArrowLeft, Loader2, Sparkles, Fingerprint,
  CheckCircle2, Globe
} from 'lucide-react';
...
export default function ResourceDownloadPage() {
  ...
  const triggerDownload = () => {
    // Chemin vers votre ressource scellée (PDF, etc.)
  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A] text-white font-sans italic selection:bg-blue-600/30">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <img src="/QS_FondEcran.webp" alt="Matrix" className="w-full h-full object-cover" />
      ...
      <nav className="fixed top-0 w-full z-50 p-8">
        <Link href="/" className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.4em] text-slate-500 hover:text-white transition-all group">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="text-left space-y-10">
          ...
          <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-[0.85] italic">
            Guide <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-500 to-indigo-500">Stratégique</span><br />
            ISO 2026.
          </h1>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="p-6 bg-white/5 border border-white/10 rounded-3xl">
              ...
              <p className="text-[10px] font-black uppercase text-white tracking-widest">Format PDF Haute Fidélité</p>
            </div>
            <div className="p-6 bg-white/5 border border-white/10 rounded-3xl">
              <Fingerprint className="text-blue-500 mb-4" size={32} />
              <p className="text-[10px] font-black uppercase text-white tracking-widest">Contenu Scellé Qualisoft</p>
            </div>
          </div>
        </div>
            ...
            {!downloadReady ? (
              <form onSubmit={handleAccessRequest} className="space-y-8">
                <div className="text-center mb-10">
                  <h3 className="text-2xl font-black uppercase italic tracking-tighter text-white">Identification Prospect</h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[9px] font-black uppercase text-slate-500 ml-4 tracking-[0.2em]">Responsable / Décideur</label>
                    <div className="relative">
                  ...
                  {/* ENTREPRISE */}
                  <div className="space-y-2">
                    <label className="text-[9px] font-black uppercase text-slate-500 ml-4 tracking-[0.2em]">Raison Sociale</label>
                    <div className="relative">
                  ...
                  {/* EMAIL */}
                  <div className="space-y-2">
                    <label className="text-[9px] font-black uppercase text-slate-500 ml-4 tracking-[0.2em]">Canal de communication</label>
                    <div className="relative">
              ...
              <div className="py-20 flex flex-col items-center space-y-8 animate-in zoom-in duration-500">
                ...
                <div className="text-center space-y-4">
                  <h3 className="text-3xl font-black uppercase italic tracking-tighter">Autorisation Accordée</h3>
      ...
      <footer className="py-12 px-6 text-center border-t border-white/5 opacity-40">
        <p className="text-[9px] font-black text-slate-600 uppercase tracking-[0.5em] italic flex items-center justify-center gap-3">
          <Globe size={12} /> QUALISOFT ELITE RD 2030 • INFRASTRUCTURE MULTI-TENANT SÉCURISÉE
        </p>
      </footer>
    </div>
  );
