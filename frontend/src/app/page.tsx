    ...
    <div className="min-h-screen bg-[#0B0F1A] text-white selection:bg-blue-600/30 selection:text-blue-200 font-sans italic">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0B0F1A]/80 backdrop-blur-2xl border-b border-white/5 px-6 md:px-12 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-8">
          ...
          {/* 🚪 BOUTON SE CONNECTER (Vers le Portail Multi-Tenant) */}
          <Link
            href="/auth/login"
            className="flex items-center gap-2 px-6 py-3 bg-blue-600 border border-blue-400/30 rounded-full text-[10px] font-black uppercase tracking-widest text-white hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/20 active:scale-95"
          >
            <LogIn size={14} />
            Se Connecter
          </Link>
      ...
      <section className="relative pt-48 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-blue-600/10 border border-blue-500/20 text-blue-400 text-[9px] font-black uppercase tracking-[0.3em] mb-10">
            ...
            LANCEMENT OFFICIEL : 02 FÉVRIER 2026
          </div>
          ...
          <p className="max-w-3xl mx-auto text-slate-400 text-lg md:text-xl font-medium italic mb-14 leading-relaxed">
            ...
            Rejoignez l&apos;élite et obtenez 14 jours d&apos;accès complet dès aujourd&apos;hui.
          </p>

          {/* 📝 FORMULAIRE D'ESSAI (Le cœur de la landing) */}
          <div id="essai" className="max-w-md mx-auto bg-white/5 border border-white/10 p-8 rounded-[3rem] shadow-3xl backdrop-blur-xl transition-all hover:border-blue-500/30">
            {!submitted ? (
              <form
                className="space-y-4"
                onSubmit={(e) => {
              ...
              >
                <div className="text-left space-y-2">
                  <label className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 ml-4">
                    Demander mon essai de 14 jours
                  </label>
              ...
              <div className="py-8 space-y-4 animate-in zoom-in duration-500">
                ...
                <h3 className="text-xl font-black uppercase italic">C&apos;est enregistré !</h3>
                <p className="text-slate-400 text-[10px] font-black uppercase tracking-tight">
                  Un officier Qualisoft vous contactera sous peu.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {[
              ...
              <div key={i} className="flex flex-col items-center space-y-3 group">
                <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center group-hover:bg-blue-600 transition-all duration-500 shadow-lg">
                  <f.icon size={20} className="text-blue-500 group-hover:text-white" />
                </div>
                <div>
