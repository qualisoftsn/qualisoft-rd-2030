    ...
    <div className="min-h-screen bg-[#0B0F1A] text-white selection:bg-blue-600/30 selection:text-blue-200 font-sans italic">
      ...
      <section className="relative pt-56 pb-24 px-6 overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div
            id="essai"
            className="max-w-lg mx-auto bg-white/5 border border-white/10 p-10 rounded-[3.5rem] shadow-[0_0_50px_rgba(0,0,0,0.5)] backdrop-blur-2xl mb-40 relative overflow-hidden"
          >
          ...
          <div className="mt-8 pt-8 border-t border-white/5">
            <p className="text-[8px] text-slate-500 uppercase font-black tracking-widest mb-4">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 text-left relative z-10 mb-20">
          <div>
            <div className="flex items-center gap-4 mb-6">
              {/* LOGO FOOTER : Remplacement par le fichier QsLogo.svg scellé */}
              <img
                src="/QsLogo.svg"
                alt="Qualisoft Elite"
            ...
            <div className="flex gap-4">
              <a
                href="#"
                aria-label="LinkedIn Qualisoft"
                className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover:border-blue-500 transition-all shadow-lg"
              >
                <Linkedin size={20} />
              </a>
              <a
                href="#"
                aria-label="X / Twitter Qualisoft"
                className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover:border-blue-500 transition-all shadow-lg"
              >
                <Twitter size={20} />
              </a>
