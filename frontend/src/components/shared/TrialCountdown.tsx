...
import { AlertTriangle, Lock, Rocket, ShieldAlert } from "lucide-react";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-1 italic">
              Le périmètre d&apos;écriture est désactivé.
            </p>
          </div>
        </div>
    ...
    return (
      <div className="bg-red-600 p-4 flex items-center justify-center gap-6 sticky top-0 z-110 shadow-2xl italic font-sans animate-pulse">
        ...
        <p className="text-sm font-black uppercase tracking-tighter text-white">
          URGENCE MASTER : Verrouillage de l&apos;instance dans{" "}
    ...
    return (
      <div className="bg-amber-500 p-4 flex items-center justify-center gap-6 sticky top-0 z-110 border-b-2 border-amber-600 shadow-xl italic font-sans">
        ...
        <p className="text-[11px] font-black uppercase tracking-widest text-slate-950 italic">
          Pilotage : notre période d&apos;essai Qualisoft expire dans{" "}
          <span className="font-mono text-lg">{daysLeft}</span> jours.
        </p>
        <button className="bg-slate-950 text-white px-6 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest border-none cursor-pointer">
          Activer
        </button>
      </div>
    );
