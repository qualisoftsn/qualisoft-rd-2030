 ...
 * DESIGN : ClickUp High-Density, Zero-Scroll, PWA Optimized.
 * SÉCURITÉ : Isolation Kernel (Zustand) - Zéro NextAuth.
 * RÉVISION : 06 Mars 2026 | 22:15 GMT
 * -------------------------------------------------------------------------
 */
...
export default function Sidebar({ isSuperAdmin }: SidebarProps) {
  ...
  return (
    <aside className="w-75 h-screen flex flex-col border-r border-white/5 bg-[#0B0F1A] font-sans italic overflow-hidden shadow-4xl select-none">
      ...
      <div className="p-6 bg-[#0F172A]/80 border-t border-white/5 shrink-0">
        <div className="p-4 bg-black/40 border border-white/5 rounded-4xl flex items-center justify-between shadow-inner group/user">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="text-left min-w-0 leading-none">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-[7px] font-black text-slate-600 tracking-widest m-0 uppercase italic truncate">{user?.U_Role}</p>
              </div>
            </div>
          </div>
          <button 
