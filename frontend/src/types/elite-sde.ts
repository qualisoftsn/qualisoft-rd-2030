 ...
 * -------------------------------------------------------------------------
 * RÔLE : Typage miroir intégral du schéma Prisma Qualisoft.
 * RÉVISION : 03 Mars 2026 | 02:50 GMT
 */

export type JsonValue = string | number | boolean | { [key: string]: JsonValue } | JsonValue[] | null;

// ==========================================
// 1. ÉNUMÉRATIONS (STRRICTEMENT PRISMA)
// ==========================================

export enum Plan { ESSAI = "ESSAI", EMERGENCE = "EMERGENCE", CROISSANCE = "CROISSANCE", ENTREPRISE = "ENTREPRISE", GROUPE = "GROUPE" }
export enum SubscriptionStatus { TRIAL = "TRIAL", ACTIVE = "ACTIVE", SUSPENDED = "SUSPENDED", EXPIRED = "EXPIRED", PENDING = "PENDING" }
export enum Role { SUPER_ADMIN = "SUPER_ADMIN", ADMIN = "ADMIN", USER = "USER", PILOTE = "PILOTE", COPILOTE = "COPILOTE", AUDITEUR = "AUDITEUR", HSE = "HSE", SAFETY_OFFICER = "SAFETY_OFFICER", RQ = "RQ", DIRECTION = "DIRECTION", OBSERVATEUR = "OBSERVATEUR" }
...
export enum NCStatus { DETECTION = "DETECTION", ANALYSE = "ANALYSE", ACTION_EN_COURS = "ACTION_EN_COURS", VERIFICATION = "VERIFICATION", CLOTURE = "CLOTURE" }
...
export enum Priority { LOW = "LOW", MEDIUM = "MEDIUM", HIGH = "HIGH", URGENT = "URGENT", CRITICAL = "CRITICAL" }
