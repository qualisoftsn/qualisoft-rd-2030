...
export class AdminService {
  ...
  constructor(
    ...
    // ❌ J'ai retiré BackupTaskService qui causait le crash
    // private readonly backupService: BackupTaskService 
  ) {}
  ...
  // Si tu avais d'autres méthodes liées aux backups, commente-les pour l'instant
  // async triggerBackup() { ... }
}